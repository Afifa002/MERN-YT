...
auth.post("/signup", async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: "admin@afifa.youtube.app",
      to: email,
      subject: "Welcome to Afifa's YouTube Clone!",
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
          <h1 style="color: #333;">Welcome to Afifa's YouTube Clone!</h1>
    ...
    const mailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; background-color: #f5f5f5; padding: 20px;">
          ...
          <p style="color: #888;">Best regards,<br/>Afifa</p>
        </div>
      `,
    };
